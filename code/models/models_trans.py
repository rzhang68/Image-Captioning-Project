...
### torch.Size([256, 24, 9490]) from orig, need to change the output from 52 to 24
...
class DecoderWithAttention(nn.Module):
    ...
    def __init__(self, attention_dim, embed_dim, decoder_dim, vocab_size, 
                     max_len=52, d_model=512,  attention_heads=16, ff_dim=1024, decoder_layers=6,
        ...
        # for transformer
        ##images
        self.entry_mapping_img = nn.Linear(encoder_dim, d_model)

        #captions
        self.entry_mapping_words = nn.Linear(embed_dim, d_model) 
    ...
    def forward(self, encoder_out, encoded_captions, caption_lengths, tgt_padding_mask=None, tgt_mask=None):
        """
        Forward propagation.
        ...
        print(caption_lengths,sort_ind)
